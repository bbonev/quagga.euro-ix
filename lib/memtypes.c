...
struct memory_list memory_list_lib[] =
{
  ...
  { MTYPE_IHASH_BODY,           "Index Hash Table body"         },
  { MTYPE_AVL_TREE,             "AVL Tree structure"            },
  { MTYPE_HEAP,                 "Heap structure"                },
  { MTYPE_PFIFO,                "Periodic FIFO"                 },
  ...
  { MTYPE_PREFIX_ID_CHUNK,      "Prefix ID chunks"              },
  { MTYPE_PREFIX_RD_ID_CHUNK,   "Prefix RD ID chunks"           },
  { MTYPE_HASH,                 "Hash"                          },
...
struct memory_list memory_list_bgp[] =
{
  ...
  { MTYPE_BGP_ASSEMBLY,         "BGP parameter assembly"        },

  { MTYPE_BGP_BRUN,             "BGP instance run-time"         },
  { MTYPE_BGP_PRUN,             "BGP peer run-time"             },
  { MTYPE_BGP_GRUN,             "BGP group run-time"            },
  ...
  { MTYPE_BGP_CONNECTION_OPS,   "BGP connection options"        },
  { MTYPE_BGP_RING_BUFF,        "BGP ring-buffer"               },
  { MTYPE_BGP_ACCEPTOR,         "BGP acceptor"                  },
  { MTYPE_BGP_READER,           "BGP reader"                    },
  { MTYPE_BGP_WRITER,           "BGP writer"                    },
  { MTYPE_BGP_FSM_EVENT,        "BGP FSM Event"                 },
  ...
  { MTYPE_AS_PATH_BODY,         "BGP aspath body"               },
  { MTYPE_AS_PATH_ENC,          "BGP aspath enc."               },
  ...
  { MTYPE_BGP_PEER_RIB,         "BGP Peer RIB"                  },
  { MTYPE_BGP_ROUTE_INFO,       "BGP Route"                     },
  { MTYPE_BGP_ROUTE_EXTRA,      "BGP ancillary route info"      },

  { MTYPE_BGP_ADJ_IN,           "BGP adj in"                    },
  { MTYPE_BGP_ADJ_OUT,          "BGP adj out"                   },
  { MTYPE_BGP_ROUTE_MPLS,       "BGP MPLS Route"                },
  { MTYPE_BGP_ATTR_FLUX,        "BGP attr in flux"              },
  { MTYPE_BGP_ROUTE_FLUX,       "BGP route in flux"             },
  ...
  { MTYPE_COMMUNITY_VAL,        "community value"               },
  { MTYPE_COMMUNITY_ENC,        "community enc."                },
  { 0, NULL },
  { MTYPE_ECOMMUNITY,           "extcommunity"                  },
  { MTYPE_ECOMMUNITY_VAL,       "extcommunity value"            },
  { MTYPE_ECOMMUNITY_ENC,       "extcommunity enc."             },
  { 0, NULL },
  ...
  { MTYPE_COMMUNITY_LIST_RAW,   "community-list raw regex"      },
  ...
  { 0, NULL },
  { MTYPE_BGP_UNKNOWN_ATTR,     "BGP unknown attr"              },
  { MTYPE_BGP_UNKNOWN_BODY,     "BGP unknown attr val"          },
  { 0, NULL },
