...
extern void bgp_damping_cmd_init (void) ;
...
extern cmd_ret_t bgp_damp_warning(vty vty) ;
extern void bgp_damp_info_vty (vty vty, route_info ri);
extern const char * bgp_damp_reuse_time_vty (vty vty, route_info ri,
                                                        char *, size_t);
